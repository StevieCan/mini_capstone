...
ProductCategory.create(category_id: 1, product_id: 9)
ProductCategory.create(category_id: 1, product_id: 10)
ProductCategory.create(category_id: 2, product_id: 11)
ProductCategory.create(category_id: 2, product_id: 13)
ProductCategory.create(category_id: 1, product_id: 3)
ProductCategory.create(category_id: 1, product_id: 14)
